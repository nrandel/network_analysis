...
# %%
neurons = pymaid.get_skids_by_annotation('nr neuron 65408') # Tel-like 10
...
# upstream 3-hops of Tel-like 10
upstream = Promat.upstream_multihop(edges=edges, sources=neurons, hops=3, pairs_combined=True)
# %%
